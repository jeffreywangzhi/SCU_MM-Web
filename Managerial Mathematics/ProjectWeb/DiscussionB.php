...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script language="JavaScript">
        ...
        function showPost(page)
        {
            ...
            xmlhttp.open("GET", "DiscussionB_Ajax.php?name="+accountInput, true);
            xmlhttp.send();
...
<body onload="showRight()">
    ...
    <br/>
        ...
        <span style="padding-left:30px; "><button onclick="javascript:location.href='PostB.php'" 
