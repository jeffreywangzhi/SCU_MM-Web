...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script language="JavaScript">
        ...
        function showPost(){
            ...
            xmlhttp.open("GET", encodeURI(encodeURI("PostCommentsShowB_Ajax.php?name="+postID)), true);
            xmlhttp.send();
        }
            ...
            if(commentCount == 20){
                ...
                xmlhttp.onreadystatechange=function(){
                    ...
                    if (xmlhttp.readyState==4 && xmlhttp.status==200){
                        ...
                        // window.alert("已發佈貼文");
                        location.href="PostCommentsB.php";
                    }
                }
                //此方法傳遞了三個參數。 'GET'確定httprequest的類型。 'ajax.php'設置後端文件，並設置第三個參數'true'表示異步處理請求。
                xmlhttp.open("GET", encodeURI(encodeURI("PostCommentsB_Ajax.php?name="+PostInfo)), true);
                xmlhttp.send();
            }else{
